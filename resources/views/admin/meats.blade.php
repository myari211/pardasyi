...
<div class="container">
        ...
        <div class="col-lg-12">
            <div class="card rounded-0">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('create.meats') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="md-form">
                            ...
                            <div class="col-lg-4">
                                <div class="card rounded-0 bordered">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <img src="{{ asset('image/Meats/'.$data->image) }}">
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-12 d-flex justify-content-center">
                                                <small class="text-muted">{{ Str::limit($data->description, 150) }}</small>
                                            </div>
                                        </div>
                                        <div class="row mt-5">
                                            <div class="col-lg-12 d-flex justify-content-between">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" data-toggle="modal" data-target="#editMeats{{ $data->id }}">Edit</a>
                                                    <a class="dropdown-item" href="javascript:void()" onclick="document.getElementById('deleteMeats{{ $data->id }}').submit();">Delete</a>
                                                    <form method="post" action="/admin/delete/meats/{{ $data->id }}" class="d-none" id="deleteMeats{{ $data->id }}">
                                                        @csrf
                                                    </form>
                                                </div>
                                            </div>
    ...
    @foreach($meats as $data)
        <div class="modal fade" id="editMeats{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            @csrf
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/admin/edit/meats/{{ $data->id }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-2">
                                <div class="col-lg-12">
