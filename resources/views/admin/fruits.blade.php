                                        ...
                                        <div class="row mt-5">
                                            <div class="col-lg-12 d-flex justify-content-between">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" data-toggle="modal" data-target="#editFruits{{ $data->id }}">Edit</a>
                                                    <a class="dropdown-item" href="javascript:void()" onclick="document.getElementById('deleteFruits{{ $data->id }}').submit(); ">Delete</a>
                                                    <form method="post" action="/admin/delete/fruits/{{ $data->id }}" id="deleteFruits{{ $data->id }}" class="d-none">
                                                        @csrf
                                                    </form>
                                                </div>
                                            </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/admin/edit/fruits/{{ $data->id }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-2">
                                <div class="col-lg-12">
