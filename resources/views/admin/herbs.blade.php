...
<div class="container">
                            ...
                            <div class="col-lg-4">
                                <div class="card rounded-0 bordered">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <img src="{{ asset('image/herbs/'.$data->image) }}">
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-lg-12 d-flex justify-content-between">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <button class="dropdown-item" onclick="event.preventDefault(); document.getElementById('deleteHerbs').submit();">Delete</button>
                                                    <form method="post" action="/admin/herbs/delete/{{ $data->id }}" id="deleteHerbs">
                                                        @csrf
                                                    </form>
                                                </div>
                                            </div>
    ...
    @foreach($herbs as $data)
        <div class="modal fade" id="editHerbs{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            @csrf
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/admin/herbs/update/{{ $data->id }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-2">
                                <div class="col-lg-12">
