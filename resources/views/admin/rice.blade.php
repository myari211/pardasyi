                                        ...
                                        <div class="row mt-5">
                                            <div class="col-lg-12 d-flex justify-content-between">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button class="dropdown-item" data-toggle="modal" data-target="#editRice{{ $data->id }}">Edit</button>
                                                    <button class="dropdown-item" onclick="event.preventDefault(); document.getElementById('deleteRice{{ $data->id }}').submit();">Delete</button>
                                                    <form method="post" action="/admin/delete/rice/{{ $data->id }}" id="deleteRice{{ $data->id }}">
                                                        @csrf
                                                    </form>
                                                </div>
                                            </div>
...
@foreach($rice as $data)
        <div class="modal fade" id="editRice{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            @csrf
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/admin/rice/update/{{ $data->id }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-2">
                                <div class="col-lg-12">
