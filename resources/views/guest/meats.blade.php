            ...
            <div class="col-lg-4 mb-2">
                <div class="card rounded-0 h-100">
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12 d-flex justify-content-center">
                                <a data-toggle="modal" data-target="#fruits{{ $data->id }}">
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-12">
                                <button type="button" class="btn btn-md btn-primary btn-block text-white rounded-0" data-toggle="modal" data-target="#fruits{{ $data->id }}">Buy</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-12">
                                <img src="{{ asset('image/meats/'.$data->image) }}" class="w-100 h-100">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
