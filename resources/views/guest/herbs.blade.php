                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4 d-flex justify-content-end">
                            <div class="col-lg-6 d-flex justify-content-end">
                                <button type="button" class="btn btn-md green-bg text-white rounded" data-toggle="modal" data-target="#herbs{{ $data->id }}">More</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-12">
                                <img src="{{ asset('image/herbs/'.$data->image) }}" style="width:100%">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
